...
export default function LeighOnSeaPage() {
  const hours = [
  ...
  return (
    <>
      <PageHero
        title="Leigh-on-Sea Practice"
        subtitle="Our Essex practice serving Leigh-on-Sea, Southend, and the surrounding areas with exceptional orthodontic care."
        breadcrumbs={[
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-16">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#1a4d3e]/70">45 Broadway</p>
                    <p className="text-[#1a4d3e]/70">Leigh-on-Sea, SS9 1PE</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:01702476789" className="text-[#1a4d3e]/70 hover:text-[#c9707d] transition-colors">
                      01702 476789
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:leigh@loraortho.com" className="text-[#1a4d3e]/70 hover:text-[#c9707d] transition-colors">
                      leigh@loraortho.com
                    </a>
                  </div>
                </div>
            ...
            >
              {/* Map Placeholder */}
              <div className="aspect-[4/3] bg-gradient-to-br from-[#c9707d]/10 to-[#c9707d]/20 rounded-2xl flex items-center justify-center mb-8">
                <div className="text-center">
                  <MapPin className="h-16 w-16 mx-auto text-[#c9707d]/40 mb-3" />
                ...
                <div className="flex items-start gap-4 bg-[#f5eeeb] rounded-xl p-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#1a4d3e]/70 text-sm">
                      Free parking available on Broadway and surrounding streets. Pay & display car park nearby.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4 bg-[#f5eeeb] rounded-xl p-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#1a4d3e]/70 text-sm">
                      5 minute walk from Leigh-on-Sea station (c2c line from London Fenchurch Street).
                    </p>
                  </div>
                </div>
              </div>
      ...
      <CTABanner
        title="Book at Our Leigh-on-Sea Practice"
        subtitle="Schedule your consultation at our Essex location."
